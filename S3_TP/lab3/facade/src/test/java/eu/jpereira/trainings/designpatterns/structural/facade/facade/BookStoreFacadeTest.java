...
import eu.jpereira.trainings.designpatterns.structural.facade.service.DefaultBookStoreFacade;
...
public class BookStoreFacadeTest extends AbstractClientTest {
	...
	protected BookstoreFacade createFacade() {
		...
		// ...
		// Return an instance of your facade implementation - done

		setupFakeServices(); // Method from AbstractClientTest
		this.bookstoreFacade = new DefaultBookStoreFacade (this.bookService,
														   this.customerService,
														   this.warehouseService,
														   this.orderingService,
														   this.customerNotificationService);
		return this.bookstoreFacade;
	}
}
