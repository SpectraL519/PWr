...
public class ReportAssemblerTest {
	...
	public void testAssembleJSONReportBody() {
		...
		ReportAssembler assembler = new ReportAssembler(new JSONReportBuilder(createDummySaleEntry()));
	...
	public void testAssembleXMLReportBody() {
		...
		// ReportAssembler assembler = new ReportAssembler();
		ReportAssembler assembler = new ReportAssembler(new XMLReportBuilder(createDummySaleEntry()));
	...
	public void testAssembleHTMLReportBody() {
		...
		// ReportAssembler assembler = new ReportAssembler();
		ReportAssembler assembler = new ReportAssembler(new HTMLReportBuilder(createDummySaleEntry()));
