...
public class OnState implements ApplianceStateBehavior {
	...
	public ApplianceState getState() {
		//TODO: return the correnponding state enum. This represents the ON State, so return ApplianceState.ON; - done
		return ApplianceState.ON;
	}

	/* (non-Javadoc)
	 * @see eu.jpereira.trainings.designpatterns.behavioral.state.appliance.state.ApplianceStateBehavior#start() - done
	 */
	@Override
